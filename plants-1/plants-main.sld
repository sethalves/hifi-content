    ...
    (define (make-plant model mesh plant-specification)
      ...
      (let* ((leaf-material
        ...
        (define (leaf q)
          ...
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p0 p1 p2)) colors)
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p0 p3 p1)) colors)
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p0 p2 p3)) colors)
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p1 p3 leaf-tip)) colors)
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p3 p2 leaf-tip)) colors)
          (mesh-append-triangle! model mesh leaf-material (map transform-point (list p2 p1 leaf-tip)) colors))
