  ...
  (begin
    (define (make-clock-hand model mesh hand-base-width hand-length hand-depth)
      (let* ((clock-hand-material (model-get-material-by-name model "clock_hand_mtl"))
        ...
        (mesh-append-triangle! model mesh clock-hand-material (list p0 p2 p1))
        (mesh-append-triangle! model mesh clock-hand-material (list p1 p2 p3))
        (mesh-append-triangle! model mesh clock-hand-material (list p0 p3 p2))
        (mesh-append-triangle! model mesh clock-hand-material (list p0 p1 p3))))
